...
BELT_BOX_DROP_ROOT_ZONES = (
    (-7.068025, -6.465390, _shifted(14.849451), _shifted(15.745693), 0.42, 0.56),
    (-4.778759, -4.167826, _shifted(14.846080), _shifted(15.749063), 0.42, 0.56),
)
