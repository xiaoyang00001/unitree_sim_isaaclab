...
#       (x=-4.74 / -6.50, y=13.998/14.748)；首批箱统一在 x=-5.62 中线上，
...
# 到下移后的工位 13.998 分别是 3.65 / 4.25 m。筐是被拖拽滑行不是被带动，实测速度约
# 0.244 m/s（低于 velocity_y 的 0.3，见 README「已知限制 / 待实测」），所以粗估约
# 15.0 / 17.4 s 到位。旧工位 y=14.398 下曾在 smoke 900 步实测停于
# 14.136 / 14.137；该结果不代表本轮 y=13.998 新停位，需重新做物理验收。
