...
| 大间距 + 长行程，减到 4 箱 | `ISAACLAB_BELT_BOX_COUNT=4 ISAACLAB_BELT_BOX_SPAWN_PITCH=0.95 ISAACLAB_BELT_BOX_SPAWN_Y_LEAD=15.1` |
| 回到密排（原默认） | `ISAACLAB_BELT_BOX_SPAWN_PITCH=0.6 ISAACLAB_BELT_BOX_SPAWN_Y_LEAD=15.5` |
