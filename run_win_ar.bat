...
REM
REM ⚠️ XR mode is a DIFFERENT pipeline from the non-AR one: it loads
...
REM
REM ⚠️ A STALE XRLink left over from an earlier session eats ~245% CPU and will
...
if not defined SIM_DDS_IFACE set "SIM_DDS_IFACE=192.168.50.127"
